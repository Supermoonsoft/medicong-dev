                ...
                <div class="row coralbg white">
                    <div class="col-md-4 no-pad">
                        <div class="user-image">
                            <img src="img/profile.png" class="img-responsive thumbnail">
                        </div>
                    </div>
                    <div class="col-md-8 no-pad">
                        <div class="user-pad text-left">
                            <h3><i class="fa fa-address-book"></i> <b>ชื่อ-สกุล</b> นาย สมใจ คนดี</h3>
                            <h4 class="white"><i class="fa fa-check-circle-o"></i> <b>CID</b> 1657985410254</h4>
                            <h4 class="white"><i class="fa fa-birthday-cake"></i> <b>วันเกิด</b> 15 มกราคม 2512</h4>
            ...
            <div class="col-md-4 user-menu user-pad">
                ...
                <div class="user-menu-content">
                    ...
                    <div class="user-pad text-left">
                        ...
                        <h4><i class="fa fa-folder-open coral"></i> <b>ที่อยู่</b> เลขที่ 1 ถ.อาทิตย์วงศ์ ต.ในเมือง อ.เมือง จ.พิษณุโลก</h4>
                ...
                <div class="user-menu-content">
                    ...
                    <div class="user-pad text-left">
                        <h4><i class="fa fa-newspaper-o coral"></i><b>ประเภทสิทธิ์การรักษา</b> ข้าราชการ</h4>
                        <h4><i class="fa fa-minus-circle coral"></i> <b>วันที่หมดอายุ</b> 15 สิงหาคม 2562</h4>
                        <h4><i class="fa fa-hospital-o coral"></i> <b>สถานบริการหลัก</b> โรงพยาบาลพุทธชินราช</h4>
