...
/**
 * SStockIcathDispenDataSearch represents the model behind the search form of `app\modules_stock\icath\models\SStockIcathDispenData`.
 */
class SStockIcathDispenDataSearch extends SStockIcathDispenData
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'vn', 'hn', 'an', 'code', 'detail', 'dispen_data_lot', 'data_json', 'requester', 'created_at', 'created_by', 'updated_at', 'updated_by', 'date_start_service', 'time_start_service', 'date_end_service', 'time_end_service'], 'safe'],
    ...
    {
        $query = SStockIcathDispenData::find();
        ...
        $query->andFilterWhere([
            ...
            'dispen_data_id' => $this->dispen_data_id,
        ...
        $query->andFilterWhere(['ilike', 'id', $this->id])
            ...
            ->andFilterWhere(['ilike', 'dispen_data_lot', $this->dispen_data_lot])
