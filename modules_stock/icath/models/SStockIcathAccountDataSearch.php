...
/**
 * SStockIcathAccountDataSearch represents the model behind the search form of `app\modules_stock\icath\models\SStockIcathAccountData`.
 */
class SStockIcathAccountDataSearch extends SStockIcathAccountData
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'vn', 'hn', 'an', 'code', 'detail', 'receive_data_lot', 'data_json', 'requester', 'created_at', 'created_by', 'updated_at', 'updated_by', 'date_start_service', 'time_start_service', 'date_end_service', 'time_end_service', 'vendor_dispen_lot'], 'safe'],
    ...
    {
        $query = SStockIcathAccountData::find();
