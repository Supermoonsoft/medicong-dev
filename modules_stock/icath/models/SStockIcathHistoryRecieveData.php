...
/**
 * This is the model class for table "s_stock_icath_history_recieve_data".
 *
 * @property string $id
 * @property string $vn
 * @property string $hn
 ...
 */
class SStockIcathHistoryRecieveData extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 's_stock_icath_history_recieve_data';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['hn'], 'string', 'max' => 9],
            [['code'], 'string', 'max' => 50],
            [['detail', 'receive_data_lot', 'requester', 'created_by', 'updated_by'], 'string', 'max' => 255],
            [['id'], 'unique'],
        ];
    }
