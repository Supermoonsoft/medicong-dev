...
/* @var $model app\modules_stock\icath\models\SStockIcathDispenDataSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sstock-icath-dispen-data-search">
    ...
    <?php // echo $form->field($model, 'dispen_data_lot') ?>

    <?php // echo $form->field($model, 'dispen_data_id') ?>
