...
$this->title = 'รายการที่มีในห้องเวชภัณฑ์ทั่วไป';
$this->params['breadcrumbs'][] = ['label' => 'MedicoStock', 'url' => ['/medicostock']];
$this->params['breadcrumbs'][] = $this->title;
$summas = app\modules_stock\icath\models\MStockIcathMasprice::find()->where(['in','charge_code',['2']])->count();
?>
<div class="mstock-icath-masprice-index">

    <h2><label class="label label-success">
<img src="../modules_stock/medicostock/img/inondrug.png" alt="..." style="width: 40px; height: 40px;">
