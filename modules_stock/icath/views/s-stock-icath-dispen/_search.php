...
/* @var $model app\modules_stock\icath\models\SStockIcathDispenSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sstock-icath-dispen-search">
    ...
    <?php // echo $form->field($model, 'send_stock') ?>

    <?php // echo $form->field($model, 'send_account') ?>

    <?php // echo $form->field($model, 'send_patient') ?>
