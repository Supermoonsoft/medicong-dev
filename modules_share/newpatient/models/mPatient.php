...
class mPatient extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['hn', 'pid', 'fname', 'sex', 'birth'], 'required', 'message' => ''],
    ...
    public function afterSave($insert, $changedAttributes) {
        ...
        $sql = "UPDATE m_patient SET agey = EXTRACT(YEAR FROM   AGE(birth) )
                ,agem = EXTRACT(MONTH FROM  AGE(birth) )
                ,aged = EXTRACT(DAY FROM  AGE(birth) )
                WHERE hn = '$this->hn' ";
