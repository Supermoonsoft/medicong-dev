...
<style>
    ...
    #footulcerfuipd-vessel_palpation_dp_right{
        display: inline-block;
    }
    #footulcerfuipd-vessel_palpation_dp_left{
        display: inline-block;
    }
    #footulcerfuipd-vessel_palpation_pt_right{
        display: inline-block;
    }
    #footulcerfuipd-vessel_palpation_pt_left{
        display: inline-block;
    }
    #footulcerfuipd-off_loading_technique{
        display: inline-block;
    }
    #footulcerfuipd-local_procedure_performed{
        display: inline-block;
    }
    #footulcerfuipd-local_dressing_performed{
        display: inline-block;
    }
    #footulcerfuipd-post_revascularization{
        display: inline-block;
    }
    #footulcerfuipd-post_hbot{
        display: inline-block;
    }
    #footulcerfuipd-period_number{
        width: 300px;
        display: inline-block;
    ...
    #footulcerfuipd-post_amputation{
        display: inline-block;
    }
